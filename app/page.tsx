                ...
                <div className="animate-in fade-in slide-in-from-right-4 mt-2 md:mt-0">
                  ...
                  {selectedCar?.status === 'Vendido' ? (
                    ...
                    <div className="flex gap-3">
                      ...
                      <a href={`https://wa.me/17868506179?text=${encodeURIComponent(`Hola, estoy interesado en el ${selectedCar?.year || ''} ${selectedCar?.brand || ''} ${selectedCar?.model || ''}.`)}`} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center px-4 md:px-5 py-4 md:py-5 bg-[#25D366] text-white font-bold rounded-xl hover:bg-[#1ebe5a] transition-all shadow-lg">
