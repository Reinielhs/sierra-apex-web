...
export default function HomePage() {
  ...
  return (
    <main className="bg-[#111C2D] text-white font-sans min-h-screen relative">
              ...
              {!showLeadForm ? (
                <div className="animate-in fade-in slide-in-from-right-4 mt-2 md:mt-0">
                  ...
                  {selectedCar?.status === 'Vendido' ? (
                    ...
                    <button onClick={() => setShowLeadForm(true)} className="w-full py-4 md:py-5 bg-sierra-gold text-black font-bold rounded-xl hover:bg-white transition-all uppercase tracking-widest text-[10px] md:text-sm shadow-[0_0_20px_rgba(212,175,55,0.3)]">{t.reqDetailsBtn}</button>
                  )}
                </div>
              ) : (
      ...
      {/* WHATSAPP */}
      <a href="https://wa.me/17868506179" target="_blank" rel="noopener noreferrer" className="fixed bottom-20 right-4 md:bottom-8 md:right-28 z-[90] w-14 h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center bg-[#25D366] shadow-2xl hover:scale-110 transition-all duration-300">
